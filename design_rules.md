# SVYNE | Strict Design Rules & Brand Standards

**Version:** 1.0 (Technical Slate / Studio White)

**Objective:** To maintain absolute visual consistency across the SVYNE platform, ensuring every pixel adheres to the "Technical Precision meets Organic Growth" philosophy.
...
- **Italics:** Use italics for "Sienna" accented words within headlines (e.g., `<em>SVYNE</em>`).
...
- **0.4s:** Heavy UI (Investment packages, Cards).
...
- **20px:** Investment packages and value cards.
