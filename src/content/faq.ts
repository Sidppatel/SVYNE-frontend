export const FAQ_ITEMS = [
  ...
  },
  {
    ...
    answer:
      'No. Customer management and scheduling can be part of the system, but SVYNE is focused on the full operation: leads, customers, jobs, scheduling, estimates, invoices, communication, reporting, and ongoing improvement.',
  },
  {
...
export const FAQ_WHY_SVYNE = [
  {
    title: 'Workflow before features',
    desc:
      'SVYNE starts by understanding how work actually happens, not by forcing your team into a generic feature list.',
  },
  {
    title: 'Systems before software',
    desc:
      'The goal is operational transformation: fewer manual steps, clearer handoffs, better visibility, and less owner dependency.',
  },
  {
    title: 'Tailored without starting from zero',
    desc:
      'Reusable modules keep delivery faster and more reliable, while configuration keeps the experience aligned with your business.',
  },
  {
    title: 'Built to keep improving',
    desc:
      'Operations change. SVYNE supports the system after launch so workflows, reporting, and automations can evolve with the business.',
  },
] as const
